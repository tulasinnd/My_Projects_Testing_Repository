...
for image_path in image_paths:
    ...
    # Display the thumbnail in a column
    st.image(image, use_column_width=True, caption=image_path)
...
# Allow users to click on the thumbnails to view the full size image
for image_path in image_paths:
    image = Image.open(image_path)
