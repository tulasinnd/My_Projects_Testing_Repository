...
def Skills():    
    ...
    colors = ['rgba(255, 99, 132, 0.4)', 'rgba(54, 162, 235, 0.4)', 'rgba(255, 206, 86, 0.4)', 'rgba(75, 192, 192, 0.4)', 'rgba(153, 102, 255, 0.4)', 'rgba(255, 159, 64, 0.4)', 'rgba(37, 121, 140, 0.4)', 'rgba(238, 130, 238, 0.4)']
    colors1 = ['#ff6600', '#36A2EB', '#ffcc00', '#4BC0C0', '#ff884d', '#FFA500', '#25798C', '#EE82EE']
    ...
    expander_style = """
        <style>
            .streamlit-expanderHeader {
                background-color: rgb(51, 204, 51, 0.4) !important;
