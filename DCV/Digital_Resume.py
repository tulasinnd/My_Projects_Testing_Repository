...
def Skills():    
    ...
    colors = ['rgb(255, 102, 255,0.2)', 'rgba(54, 162, 235, 0.4)', 'rgba(255, 206, 86, 0.4)', 'rgba(75, 192, 192, 0.4)', 'rgba(153, 102, 255, 0.4)', 'rgba(255, 159, 64, 0.4)', 'rgba(37, 121, 140, 0.4)', 'rgba(238, 130, 238, 0.4)']
    colors1 = ['#ff66ff', '#36A2EB', '#ffcc00', '#4BC0C0', '#bf80ff', '#FFA500', '#25798C', '#EE82EE']
